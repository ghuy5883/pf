...
public:
    ...
    static float Dot(const Vector2& a, const Vector2& b)
    {
        // TODO Lab 01a
		/*
		Dot product:	x-component = VectorA.x + VectorB.x
						y-component = VectorA.y + VectorB.y

						or

						magnitude(VectorA)*magnitude(VectorB)*cos(angle)
		*/
    ...
    static Vector2 Lerp(const Vector2& a, const Vector2& b, float f)
    {
        // TODO Lab 01b
		/*
		Lerp:	VectorA + constant(VectorB - VectorA)
		*/
...
public:
    ...
    void Normalize()
    {
        // TODO Lab 01c
        /*
        Normalize:	VectorA / magnitude(VectorA)

                    magnitude of a vector = sqrt( VectorA.x ^ 2 + VectorA.y ^ 2 + VectorA.z ^ 2)
        */
        float magn = Length();
        x /= magn;
        y /= magn;
    ...
    friend Vector3 Cross(const Vector3& a, const Vector3& b)
    {
        // TODO Lab 01c
        /*
        Cross product:  x-component: (VectorA.y * VectorB.z) + (VectorA.z * VectorB.y)
                        y-component: (VectorA.z * VectorB.x) + (VectorA.x * VectorB.z)
                        z-component: (VectorA.x * VectorB.y) + VectorA.y * VectorB.x)
        */
